...
\begin{frame}[fragile]{Qu'est-ce qu'une fonction de hachage ?}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \footnotesize
      Une fonction de hachage \texttt{h} \textbf{mélange les bits} d'un entier :
      \begin{itemize}
...
\end{lstlisting}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{tikzpicture}
        ...
        \node[draw,rounded corners,fill=cPurple!15,minimum height=1.7cm,minimum width=1.1cm] (h) at (1.7,0) {$h$};
...
\begin{frame}[fragile]{Bottom-$s$ MinHash : garder les $s$ plus petits hachés}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \footnotesize
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{tikzpicture}
        ...
        \draw[decorate,decoration={brace,amplitude=4pt},cBlue]
          (0.25,0.4)--(1.55,0.4)
          node[midway,above,font=\scriptsize,cBlue]{$s$ plus petits};
        \node[font=\scriptsize,cGray,align=center] at (3.3,-0.7)
          {les autres k-mers\\sont ignorés};
      \end{tikzpicture}
    \end{column}
  \end{columns}
\end{frame}
