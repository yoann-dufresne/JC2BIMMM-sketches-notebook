...
\begin{frame}{HyperMin : la signature d'un minimum sur 16 bits}
  ...
  \begin{tikzpicture}[scale=0.82]
    ...
    % --- la signature (16 bits) ---
    \draw[cBlue,line width=1pt] (2.5,-1.05) rectangle (6.0,-0.5);
    \node[cBlue,font=\scriptsize,align=center] at (4.25,-0.775){\textbf{6 bits} : sa position\\($\log_2 64 = 6$)};
    \draw[cOrange,line width=1pt] (6.0,-1.05) rectangle (9.5,-0.5);
    \node[cOrange,font=\scriptsize,align=center] at (7.75,-0.775){\textbf{10 bits}\\de poids faible};
    \node[font=\scriptsize,anchor=west] at (9.75,-0.775){$=$ 16 bits};
    \draw[arr,cBlue]   (4.77,1.4) to[out=-90,in=90] (4.25,-0.48);
    \draw[arr,cOrange] (10.45,1.4) to[out=-90,in=90] (7.75,-0.48);
  \end{tikzpicture}
  \end{center}
